...
<script>
    ...
    // Dummy data for SPBE/BPT
    const spbeBptData = [
        { id: 1, nama: 'SPBE Sukamaju', kode_plant: 'PL-001', stok_awal: 250, penerimaan: 1000, penyaluran: 800, stok: 450, tanggal: '2025-07-28', tipe: 'SPBE', sa_region: 'SA Jambi', kabupaten: 'Muaro Jambi' },
        { id: 2, nama: 'BPT Sejahtera', kode_plant: 'PL-002', stok_awal: 180, penerimaan: 500, penyaluran: 350, stok: 330, tanggal: '2025-07-27', tipe: 'BPT', sa_region: 'SA Jambi', kabupaten: 'Tanjung Jabung Timur' },
        { id: 3, nama: 'SPBE Mandiri', kode_plant: 'PL-003', stok_awal: 200, penerimaan: 400, penyaluran: 200, stok: 400, tanggal: '2025-07-26', tipe: 'SPBE', sa_region: 'SA Bengkulu', kabupaten: 'Bengkulu Utara' },
        { id: 4, nama: 'BPT Jaya Abadi', kode_plant: 'PL-004', stok_awal: 600, penerimaan: 1000, penyaluran: 500, stok: 1100, tanggal: '2025-07-25', tipe: 'BPT', sa_region: 'SA Bengkulu', kabupaten: 'Rejang Lebong' },
        { id: 5, nama: 'SPBE Maju Bersama', kode_plant: 'PL-005', stok_awal: 180, penerimaan: 300, penyaluran: 150, stok: 330, tanggal: '2025-07-24', tipe: 'SPBE', sa_region: 'SA Lampung', kabupaten: 'Lampung Selatan' },
        { id: 6, nama: 'BPT Sentosa', kode_plant: 'PL-006', stok_awal: 250, penerimaan: 400, penyaluran: 200, stok: 450, tanggal: '2025-07-23', tipe: 'BPT', sa_region: 'SA Lampung', kabupaten: 'Pringsewu' },
        { id: 7, nama: 'SPBE Mufakat', kode_plant: 'PL-007', stok_awal: 80, penerimaan: 150, penyaluran: 75, stok: 155, tanggal: '2025-07-22', tipe: 'SPBE', sa_region: 'SA Sumsel', kabupaten: 'Palembang' },
        { id: 8, nama: 'BPT Harapan', kode_plant: 'PL-008', stok_awal: 180, penerimaan: 250, penyaluran: 100, stok: 330, tanggal: '2025-07-21', tipe: 'BPT', sa_region: 'SA Sumsel', kabupaten: 'Ogan Ilir' },
        { id: 9, nama: 'SPBE Bahagia', kode_plant: 'PL-009', stok_awal: 60, penerimaan: 80, penyaluran: 30, stok: 110, tanggal: '2025-07-20', tipe: 'SPBE', sa_region: 'SA Babel', kabupaten: 'Bangka' },
        { id: 10, nama: 'BPT Makmur', kode_plant: 'PL-010', stok_awal: 45, penerimaan: 50, penyaluran: 10, stok: 85, tanggal: '2025-07-19', tipe: 'BPT', sa_region: 'SA Babel', kabupaten: 'Belitung' },
    ];
    ...
    function updateBranchNames(branchName) {
        ...
        document.getElementById('table-branch-name').textContent = `Tabel Stok SPBE/BPT - ${branchName}`;
    }
    ...
    function renderTable1() {
        ...
        if (dataPage.length === 0) {
            ...
            dataPage.forEach((item, index) => {
                // Modified the detail URL to pass `sa_region` and `spbe_bpt_nama`
        ...
        document.querySelectorAll('.edit-btn').forEach(button => {
            button.addEventListener('click', function() {
                ...
                if (spbe) {
                    ...
                    document.getElementById('edit-kabupaten').value = spbe.kabupaten;
                    if (spbe.tipe === 'SPBE') {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.getElementById('saveSpbeBpt').addEventListener('click', function() {
            ...
            console.log('Saving changes:', { id, nama, kode_plant, tipe, sa_region, kabupaten });
